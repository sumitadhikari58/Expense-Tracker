// app/sign-in/page.jsx (or pages/sign-in.jsx depending on routing setup)
        ...
        <main className="w-full flex">
            <div className="relative flex-1 hidden items-center justify-center h-screen bg-gray-900 lg:flex">
                <div className="relative z-10 w-full max-w-md">
                    ...
                    <div className=" mt-16 space-y-3">
                        <h3 className="text-white text-3xl font-bold">Start managing your expenses smartly</h3>
                        <p className="text-gray-300">
                            Create an account and get access to all features, No credit card required.
                        </p>
                    ...
                    <div
                        ...
                        style={{
                            background: "linear-gradient(152.92deg, rgba(255, 183, 77, 0.2) 4.54%, rgba(255, 138, 101, 0.26) 34.2%, rgba(255, 183, 77, 0.1) 77.55%)", filter: "blur(118px)"
                        }}
                    ></div>
                </div>
            </div>
            <div className="flex-1 flex items-center justify-center h-screen">
                <div className="w-full max-w-md space-y-8 px-4 bg-white text-gray-600 sm:px-0">
                    <div>
                        <img src="logo.svg" width={150} className="lg:hidden" />
                    ...
                    <div className="grid grid-cols-3 gap-x-3">
                        {/* Add your Google/Twitter/Facebook button code here */}
                    </div>
